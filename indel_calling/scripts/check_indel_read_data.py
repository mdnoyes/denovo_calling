...
def get_sample_list(bams, family_id):
	sample_list = []
...
def main(input, hifi_source_file, reference, manifest, family, sample, platform, output):
	...
	samples = get_sample_list(bam_df, family)
...
if __name__ == "__main__":
	...
	main(snakemake.input.indels, snakemake.params.hifi_sources, snakemake.params.reference, snakemake.params.bam_manifest, snakemake.params.family, snakemake.params.sample, snakemake.params.platform, snakemake.output.read_summary)
