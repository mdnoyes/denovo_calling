...
def cross_platform_validated(pf_data):
	...
	if hifi_val  == 'true_de_novo':
		...
		if ont_val == 'false_positive':
			...
			if ilm_val in ['false_positive', 'missing_parent_data', 'missing_child_data', 'biallelic']:
	...
	if hifi_val == 'biallelic':
		if ont_val == 'biallelic' or ilm_val == 'biallelic':
			return 'biallelic'
		if ont_val == 'true_de_novo' and ilm_val == 'true_de_novo':
			return 'true_de_novo'
		if ont_val == 'false_positive' or ilm_val == 'false_positive':
			return 'false_positive'
		else:
			return 'false_positive'
	...
	if hifi_val == 'cell_line_only':
		if ont_val == 'true_de_novo' and ilm_val == 'true_de_novo':
			return 'true_de_novo'
		elif ont_val == 'true_de_novo' and ilm_val == 'biallelic':
			return 'false_positive'
		elif ont_val == 'biallelic' and ilm_val == 'true_de_novo':
			return 'false_positive'
...
if __name__ == "__main__":
	...
	main(snakemake.input.platform_validations, snakemake.output.validated_calls)
