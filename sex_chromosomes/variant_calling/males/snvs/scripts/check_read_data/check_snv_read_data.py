...
def main(variants, bams, family, platform, denovo_sample, who):
	...
	if who == 'family':
		...
		reads_out = open(f'read_data/chrX_no_PAR/{family}_{denovo_sample}_{platform}.all_samples.read_data.tsv', 'w')
		samples_out = open(f'read_data/chrX_no_PAR/{family}_{denovo_sample}_{platform}.all_samples.read_summary.tsv', 'w')
