...
def main(variants, bams, family, platform, denovo_sample):
	...
	reads_out = open(f'read_data/chrX_no_PAR/{family}_{denovo_sample}_{platform}.read_data.tsv', 'w')
	samples_out = open(f'read_data/chrX_no_PAR/{family}_{denovo_sample}_{platform}.read_summary.tsv', 'w')
